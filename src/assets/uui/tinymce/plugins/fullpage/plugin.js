...
tinymce.PluginManager.add('fullpage', function(editor) {
	...
	function dataToHtml(data) {
		...
		// Serialize journalHeader fragment and crop away body part
	...
	function setContent(evt) {
		...
		// Fixed so new document/setContent('') doesn't remove existing journalHeader/footer except when it's in source code view
		...
		// Parse journalHeader and update iframe
		headerFragment = parseHeader();
